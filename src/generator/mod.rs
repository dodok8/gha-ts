...
impl TypeGenerator {
    ...
    async fn generate_index_dts(&self, action_infos: &[ActionTypeInfo]) -> Result<()> {
        ...
        // Type imports
        content.push_str("import type { JobStep, JobDefinition, WorkflowConfig, WorkflowDefinition, Step, Permissions, Service, Container, WorkflowTrigger, ScheduleTrigger, WorkflowDispatchInput, WorkflowOn } from './base';\n");
...
"#);
        ...
        // Type re-exports
        content.push_str("\nexport type { JobStep, Step, JobDefinition, Service, Container, Permissions, WorkflowTrigger, ScheduleTrigger, WorkflowDispatchInput, WorkflowOn, WorkflowConfig, WorkflowDefinition } from './base';\n");
        for info in &sorted_infos {
            if info.has_outputs {
                content.push_str(&format!(
    ...
    async fn generate_index_js(&self, action_infos: &[ActionTypeInfo]) -> Result<()> {
        ...
        content.push_str(r#"export function getAction(ref) {
