...
impl TypeGenerator {
    ...
    pub async fn generate_types_for_refs(&self, action_refs: &HashSet<String>) -> Result<Vec<PathBuf>> {
    ...
    async fn generate_index_file(&self, generated_files: &[PathBuf]) -> Result<()> {
