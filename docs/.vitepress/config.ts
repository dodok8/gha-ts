          ...
          "/ko/guide/": [
            {
              text: "가이드",
              items: [
                { text: "왜 gaji인가?", link: "/ko/guide/why" },
