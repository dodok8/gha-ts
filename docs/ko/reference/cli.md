...
| 옵션                     | 설명                                                                        |
|--------------------------|-----------------------------------------------------------------------------|
| `-i, --input <PATH>...`  | 스캔할 디렉토리 또는 개별 `.ts` 파일 (설정의 `workflows_dir` 값을 따름)     |
...
| 옵션 | 설명 |
|------|------|
| `-i, --input <PATH>...` | TypeScript 워크플로우 디렉토리 또는 개별 `.ts` 파일 (설정의 `workflows_dir` 값을 따름) |
| `-o, --output <DIR>` | YAML 파일 출력 디렉토리 (설정의 `output_dir` 값을 따름) |
